...
Route::name("dashboard.")->prefix("/dashboard")->middleware(['auth', '2fa'])->group(function () {
    // dashboard home
...
Route::middleware(['auth'])->group(function () {
    Route::get('/2fa', [TwoFAController::class, 'showVerifyPage'])->name('2fa.verify');
    Route::post('/2fa', [TwoFAController::class, 'verifyOtp']);
});
Route::get('/2fa/setup', [TwoFAController::class, 'show2faSetup'])->middleware('auth')->name('2fa.setup');
Route::post('/2fa/disable', [\App\Http\Controllers\TwoFAController::class, 'disable2FA'])->name('2fa.disable');
Route::get('/sitemap.xml', function () {
    ...
    foreach (\App\Models\Post::all() as $post) {
        $sitemap->add(Url::create(route('frontend.post', $post->slug)));
    }
